...
1. Using the USB flash drive, create a bootable USB flash drive using the [Media Creation Tool](https://www.microsoft.com/en-us/software-download/windows10) from Microsoft, it can be found under the headline "Create Windows 10 Installation Media".
