...
> [!NOTE] Information
>
> You do this by entering your system BIOS to change the Boot Order, if you don't know the BIOS key, you can Google your motherboard manufacturer for the correspond key.
