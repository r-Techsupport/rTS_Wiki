...
1. Boot into the new `INSTALL` partition

> [!NOTE] Information
>
> You do this by entering your system BIOS to change the Boot Order. Hold Shift key and click Restart to open WinRE. Click `Troubleshoot` then `UEFI Firmware Settings`, this will redirect you to BIOS.
