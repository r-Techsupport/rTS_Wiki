...
description: A how to guide on install linux to your computer. This page also gives some suggestions for which distro is best for the use case. In addition, it gives some pointers after the operating system is installed.
---
