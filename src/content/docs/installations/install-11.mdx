...
1. Create a bootable USB flash drive using the [Media Creation Tool](https://www.microsoft.com/en-us/software-download/windows11) from Microsoft. It can be found under the headline "Create Windows 11 Installation Media"
...
> - TPM is enabled
> - The drive controller mode is set to AHCI/NVMe or RAID/VMD/IRST are disabled
...
4.  Continue on until you hit the “Which type of installation do you want?” screen. Click `Custom`. 
