...
description: A Guide for how to install Windows 11. There are two parts, first is a how to make the usb to install with. The second is the steps to go through when installing Windows 11.
---
