...
Using MCT to create the installation media
   ...
   1. Create a bootable USB flash drive using the [Create Windows 11 Installation Media download](https://www.microsoft.com/en-us/software-download/windows11) from Microsoft. This will also wipe any data stored on the USB flash drive.
...
> Save MCT to Desktop or Downloads folder. MCT must be saved and run from outside the USB flash drive. Just moving an ISO file to the USB flash drive will not make it bootable.
    ...
    3. You can leave this to default, press next.
     ...
     ![aPC.png](../../../assets/install-11/aPC.webp)5. Select USB flash drive, then press next.
...
If MCT method failed, grab win11 ISO from microsoft ite and use one of the methods below:
<details markdown="1">
...
Our guide for using [Ventoy](/installations/install-11)
...
> - Enable Secure Boot
> - Enable TPM (For AMD systems this may be called "fTPM", for Intel systems this may be called "Intel Platform Trust Technology (PTT)")
...
5.  Continue on until you reach the “Which type of installation do you want?” screen. Click "Custom". 
...
If you need to setup Windows 11 without an internet connection or without a Microsoft account, follow this [article](/guides/bypass-11).
