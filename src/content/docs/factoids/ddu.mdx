...
> DDU does not erase any personal files. It only wipes the selected driver, NVIDIA App, AMD Adrenalin, Intel ARC/GCS, HDR, display color profiles, settings, etc
