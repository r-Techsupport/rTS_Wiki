...
To only clean shader cache of the GPU, select the "GPU" device type from the drop-down list on the right, select the GPU driver, and click `Clean Shader Cache (Only)`.

![ddu2.png](../../../assets/factoids/ddu_shadercache.png)
