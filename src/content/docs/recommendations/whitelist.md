...
|| [PeaZip](https://peazip.github.io/index.html) | File archiver tool similar to 7-zip with wider format support but a less user friendly UI that also works on MacOS and Linux.
