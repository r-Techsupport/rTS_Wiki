...
It can create an image of the entire drive or clone it to another drive, and it intelligently handles bad sectors to maximize data recovery. Clonezilla is best run from a bootable live media, so you will need to create a bootable USB or CD/DVD with [Clonezilla](https://clonezilla.org/clonezilla-live.php) to use it. Alternatively, you may utilize the rTS Debian live media created in [this guide](/live-sessions/linux-live-session) which already comes with Clonezilla pre-installed.
