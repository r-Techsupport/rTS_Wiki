...
> [!NOTE] Information
>
> `gddrescue` is one of the preinstalled packages for our [r/Techsupport Rescue Media](/live-sessions/linux-live-session). If you are using this live image, you can skip the installation section.

> [!TIP] How to install gddrescue
>
> Refer below for installation instructions if you are not using our live image or want to install it on your own system.
>
> <details markdown='1'>
>   <summary>Installing gddrescue</summary>
>
...
### Running gddrescue: Clone to image file
