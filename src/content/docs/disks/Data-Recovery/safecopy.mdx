...
> [!NOTE] Information
>
> `safecopy` is one of the preinstalled packages for our [r/Techsupport Rescue Media](/live-sessions/linux-live-session). If you are using this live image, you may skip this section.
...
```sh
grep -r BaDbLoCk /mnt/image_mount after mounting image.
```
