---
title: Photorec
description: A step-by-step guide to using Photorec, a powerful data recovery tool, to recover files from a disk that has been accidentally overwritten or formatted.
sidebar:
    hidden: false
has_children: false
