...
### My disk is physically failing (gddrescue)
...
For these issues, use [gddrescue](/disks/data-recovery/gddrescue) to create an image of the failing disk before attempting any other recovery methods.
